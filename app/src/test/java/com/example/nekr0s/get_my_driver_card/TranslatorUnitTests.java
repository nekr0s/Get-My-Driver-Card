...
public class TranslatorUnitTests {
    ...
    @Test
    public void Bulgarian_To_Latin_Should_Be_Correct() throws Exception {
    ...
    @Test
    public void Input_WithInvalidSymbols_ShouldSkip_Transliterate_InvalidSymbols() throws Exception {
        Translator translator = new Translator();
    ...
    @Test
    public void Test_If_FileDirectory_IsCorrect() throws Exception {
        // Check path
